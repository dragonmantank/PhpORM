...
class ArrayStorageCollectionTest extends PHPUnit_Framework_TestCase
{
    protected function _getDao()
    {
        ...
        $collection = new PhpORM_Collection($data);
        $dao->setStore($collection);
    ...
    public function testFetchAll()
    {
        ...
        $this->assertEquals($dao->fetchAll()->toArray(), $data);
    }
